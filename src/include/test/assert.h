...
#define assert_equals_str(expected, actual, msg)                               \
    _assert_equals_str(__FILE__, __LINE__, expected, actual, msg)
#define assert_equals_uint(expected, actual, msg)                              \
    _assert_equals_uint(__FILE__, __LINE__, expected, actual, msg)
#define assert_equals_ptr(expected, actual, msg)                               \
    _assert_equals_ptr(__FILE__, __LINE__, expected, actual, msg)
#define END_DESCRIBE 0xABCD
#define describe(name, ...)                                                    \
    _describe(__FILE__, __LINE__, name, __VA_ARGS__, END_DESCRIBE)
