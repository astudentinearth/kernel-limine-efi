...
void test_str_equals()
{
    ...
    describe("str_equals", assert(str_equals(a, b), "a, b"),
...
void test_itoa()
{
    ...
    describe(
        "itoa", assert_equals_str("12345", buf1, ""),
        assert_equals_str("-120", buf2, ""), assert_equals_str("-14", buf3, ""),
        assert_equals_str("12", buf4, ""), assert_equals_str("1234", buf5, ""));
}
